                           ...
                           <div className="px-6 pt-4 space-y-2">
                                ...
                                >
                                    <div className="flex items-center space-x-2">
                                        <RadioGroupItem value="whatsapp" id={`whatsapp-collection-${cardId}`} />
                                        <Label htmlFor={`whatsapp-collection-${cardId}`} className="font-normal">Order on WhatsApp</Label>
                                    </div>
                                    <div className="flex items-center space-x-2">
                                        <RadioGroupItem value="call" id={`call-collection-${cardId}`} />
                                        <Label htmlFor={`call-collection-${cardId}`} className="font-normal">Call to Order</Label>
                                    </div>
                                </RadioGroup>
                           </div>
