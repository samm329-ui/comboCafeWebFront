...
import { Facebook, Instagram, CakeSlice, Gift, Flower, Home, PartyPopper, Heart, Sparkles, Package, ShoppingCart, User, Phone, Utensils } from "lucide-react";
...
export const config = {
  ...
  productSections: {
    ...
    gifts: [
      ...
      { id: "g13", name: "Customised Mug", price: "199", imageUrl: "https://gpfocwgfedokhmfsbcpy.supabase.co/storage/v1/object/public/asset/mug/WhatsApp%20Image%202026-01-26%20at%2008.07.03%20(1).jpeg", description: "A perfect gift with a personal touch." },
      { id: "g14", name: "Customised Mug", price: "199", imageUrl: "https://gpfocwgfedokhmfsbcpy.supabase.co/storage/v1/object/public/asset/mug/WhatsApp%20Image%202026-01-26%20at%2008.07.03%20(2).jpeg", description: "Start your day with a custom memory." },
      { id: "g15", name: "Customised Mug", price: "199", imageUrl: "https://gpfocwgfedokhmfsbcpy.supabase.co/storage/v1/object/public/asset/mug/WhatsApp%20Image%202026-01-26%20at%2008.07.03.jpeg", description: "Your favorite picture on a high-quality mug." },
      { id: "g16", name: "Customised Mug", price: "199", imageUrl: "https://gpfocwgfedokhmfsbcpy.supabase.co/storage/v1/object/public/asset/mug/WhatsApp%20Image%202026-01-26%20at%2008.07.04.jpeg", description: "A unique and thoughtful personalized gift." },
      ...
      { id: "g2", name: "Coffee Mug", price: "135", imageUrl: "https://gpfocwgfedokhmfsbcpy.supabase.co/storage/v1/object/public/asset/gift%20images/Coffee%20Mug%20(2)%20199.jpeg", description: "A stylish mug for your favorite beverage." },
  ...
  mobile: {
    ...
    bottomNav: [
      ...
      { id: "food", label: "Food", href: "/food", Icon: Utensils },
